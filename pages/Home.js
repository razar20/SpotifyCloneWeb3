    ...
    <>
      <Tabs defaultActiveKey="1" centered>
              <TabPane tab="FEATURED" key="1">
                <h1 className="featuredTitle">Enjoy the New Arrivals</h1>
              ...
              <TabPane tab="GENRES & MOODS" key="2">
                <h1 className="featuredTitle">Top Pop Music</h1>
                <div className="albums">
                ...
                <h1 className="featuredTitle">Cult Classics</h1>
                <div className="albums">
                  {library.slice(5, 11).map((e) => (
                    <Link to="/album" state={e} className="albumSelection">
                      <img
              ...
              <TabPane tab="NEW RELEASES" key="3">
                <h1 className="featuredTitle">Hot Arrivals</h1>
                <div className="albums">
                  {library.map((e) => (
                    <Link to="/album" state={e} className="albumSelection">
                      <img
